...
public class ActionListener implements IMqttActionListener {
    ...
    private void subscribe() {
        ...
        c.addAction(actionTaken);
        //Notify.toast(context, actionTaken, Toast.LENGTH_SHORT);
        Log.e(TAG, "subscribe: " + actionTaken);
    ...
    private void publish(Throwable exception) {
        ...
        Log.i(TAG,"publish action=   "+action);
    ...
    private void subscribe(Throwable exception) {
        ...
        c.addAction(action);
        //Notify.toast(context, action, Toast.LENGTH_SHORT);
        Log.i(TAG,"subscribe action=   "+action);
    ...
    private void connect(Throwable exception) {
        ...
        Log.i(TAG,"connect exception=  Client failed to connect "+action);
